...
class CalendarWeekController {
  ...
  /// Return [true] if attached to [CalendarWeek1] widget
...
class CalendarWeek1 extends StatefulWidget {
  ...
  factory CalendarWeek1(
          ...
          TextStyle todayDateStyle = const TextStyle(
              color: Color.fromARGB(255, 224, 214, 199), fontWeight: FontWeight.w400),
          Color todayBackgroundColor = Colors.white,
          Color pressedDateBackgroundColor = Colors.white,
          TextStyle pressedDateStyle =
              const TextStyle(color: Color.fromARGB(255, 21, 108, 179), fontWeight: FontWeight.w400),
          Color dateBackgroundColor =  const Color.fromARGB(255, 23, 108, 142),
          Function(DateTime)? onDatePressed,
          Function(DateTime)? onDateLongPressed,
          Color backgroundColor =const Color.fromARGB(255, 45, 137, 174),
  ...
  @override
  _CalendarWeek1State createState() => _CalendarWeek1State();
}

class _CalendarWeek1State extends State<CalendarWeek1> {
  ...
  Widget _monthItem(String title) => Align(
        ...
        child: Container(
            ...
            child: Text(
              title,
              style: const TextStyle(color: Color.fromARGB(255, 45, 137, 174), fontWeight: FontWeight.w600),
